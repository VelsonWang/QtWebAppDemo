...
/**
  ...
  - minLevel If bufferSize=0: Messages with lower level discarded.<br>
             If buffersize>0: Messages with lower level are buffered, messages with equal or higher level trigger writing the buffered content.<br>
             Defaults is 0=debug.
